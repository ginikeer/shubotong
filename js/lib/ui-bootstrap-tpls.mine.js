...
.controller('CarouselController', ['$scope', '$element', '$interval', '$animate', function ($scope, $element, $interval, $animate) {
  ...
  self.select = $scope.select = function(nextSlide, direction) {
    var nextIndex = $scope.indexOfSlide(nextSlide);
		if(self.slides.length > 0 && nextIndex == self.slides.length - 1) {
...
angular.module("template/carousel/carousel.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/carousel/carousel.html",
    ...
    "        <li ng-show=!showTrial ng-repeat=\"slide in slides | orderBy:indexOfSlide track by $index\" ng-class=\"{active: isActive(slide)}\" ng-click=\"select(slide)\"></li>\n" +
		"				 <li ng-show=showTrial class=\"trial\"><a href='home.html'>立即体验</a></li>\n" +			
    "    </ol>\n" +
