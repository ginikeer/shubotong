...
var ngTouchClickDirectiveFactory = ['$parse', '$timeout', '$rootElement',
  ...
  var TAP_DURATION = 300; // Shorter than 750ms is a tap, longer is a taphold or drag.
  var MOVE_TOLERANCE = 6; // 12px seems to work in most mobile browsers.
  var PREVENT_DURATION = 2.5; // 2.5 seconds maximum from preventGhostClick call to click
  var CLICKBUSTER_THRESHOLD = 10; // 25 pixels in any dimension is the limit for busting clicks.
